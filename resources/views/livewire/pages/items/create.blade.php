		...
		<dl class="divide-y divide-gray-100">
			<div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:px-6">
				...
				<dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
					<livewire:components.select return="id" :items="App\Models\Product::all()" title="description"
							...
							<x-laravel-blade-sortable::sortable-item
								...
								<div class="bg-white flex flex-1 items-center justify-between py-3">
									...
									<div class="flex items-center w-full space-x-3">
										<div class="flex-1">
											<livewire:components.select wire:key="select-{{$k}}-{{$product['id']}}" return="id" :items="App\Models\Product::all()" title="description"
